        ...
        <div className="flex flex-wrap justify-between md:flex-row gap-6">
            ...
            <div className="relative text-center">
              ...
              {account && (
                <div className="flex justify-center space-x-4 mt-4">
                  {account.instagram && (
                    <a href={`//${account.instagram}`} target="_blank" rel="noopener noreferrer" className="text-warm-olive hover:text-gray-900">
                  ...
                  {account.facebook && (
                    <a href={`//${account.facebook}`} target="_blank" rel="noopener noreferrer" className="text-warm-olive hover:text-gray-900">
                      <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {account.twitter && (
                    <a href={`//${account.twitter}`} target="_blank" rel="noopener noreferrer" className="text-warm-olive hover:text-gray-900">
                      <FaXTwitter className="h-6 w-6" />
                    </a>
                  )}
                  {account.tiktok && (
                    <a href={`//${account.tiktok}`} target="_blank" rel="noopener noreferrer" className="text-warm-olive hover:text-gray-900">
                      <FaTiktok className="h-6 w-6" />
                    </a>
                  )}
                  {account.pinterest && (
                    <a href={`//${account.pinterest}`} target="_blank" rel="noopener noreferrer" className="text-warm-olive hover:text-gray-900">
          ...
          <div className="mx-auto md:mx-0 w-full md:w-auto">
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Home</Link></li>
              <li><Link href="/blog" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Blog Inspiratie</Link></li>
              <li><Link href="/help" className="text-warm-olive hover:text-gray-900">Help</Link></li>
              <li><Link href="/search" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Zoek Vrienden</Link></li>
            </ul>
          </div>
          ...
          <div className="mx-auto md:mx-0 w-full md:w-auto">
            ...
            <ul className="space-y-2">
              <li><Link href="/terms-and-conditions" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Algemene Voorwaarden</Link></li>
              <li><Link href="/user-guide" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Hoe werkt Wish2Share?</Link></li>
              <li><Link href="/about-us" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Over ons</Link></li>
              <li><Link href="/help" className="text-warm-olive hover:text-gray-900" onClick={scrollToTop}>Help</Link></li>
            </ul>
          </div>
