...
import ProfilePage from "@/app/admin-dashboard/ProfilePage";
import AddAccount from "@/app/admin-dashboard/AddAccount";
import Metrics from "@/components/Metrics";
import WebBackGrounds from "@/app/admin-dashboard/dashboard/WebBackGrounds";
import AffiliateStores from "@/app/admin-dashboard/dashboard/AffiliateStores";
import Blog from "@/app/admin-dashboard/Blog";
import Inquries from "@/app/admin-dashboard/dashboard/Inquries";
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          {tab === "settings" && subTab === "affliate-stores" && <AffiliateStores />}
          {tab === "blogs" && <Blog />}
          {tab === "inquiries" && <Inquries />}
          {tab === "accounts" && <AddAccount />}
