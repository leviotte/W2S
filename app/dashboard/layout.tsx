...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const showLoginModal = (onSuccess?: () => void, redirectPath = "/dashboard") => {
    ...
    setLoginSuccessCallback(() => () => {
      ...
      if (!currentUrl.includes("/event/participation/") && !currentUrl.includes("/event/self-register/")) {
  ...
  return (
    <AuthContext.Provider value={{ showLoginModal, showRegisterModal, isAuthenticated, loading }}>
      {children}
      <LoginModal
...
// Hier kan je straks <Navbar>, <BackgroundPattern>, <BackgroundTheme>, <AuthSpinner>, <Footer> toevoegen in de layout wrapper
